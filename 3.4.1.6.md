...
| Links: | None.|
| SRS Document | 3.2.8 |
| Description/Notes:| Accessing An Assigment
1. Assignments are displayed to the User on the Calendar as links
A. Users clicks on one of the links
2. Assignment is displayed to the user.|
